...
class Variables:
    ...
    def load(self):
        self.i = mywindow.is_float(self.main_window.ui.doubleSpinBox_9)
...
class mywindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        if DEDUG:
            self.ui.doubleSpinBox_9.setValue(7)  # i
            self.ui.doubleSpinBox_10.setValue(2)  # n
            self.ui.doubleSpinBox_11.setValue(22)  # h
...
class Finish(QtWidgets.QDialog):
    def __init__(self, parent: mywindow):
        ...
        self.ui.doubleSpinBox_10.setValue(round(self.parent.calculation.r, 2))
